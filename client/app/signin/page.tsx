...
export default function SigninPage() {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      const response = await fetch(`${baseURL}/pages/signin`, {
        method: 'POST',
        headers: {
        ...
        <div className="md:w-1/2 p-6 flex flex-col justify-center">
          <div className="mb-8 max-w-lg">
            ...
            <h2 className="text-3xl font-semibold mb-6 text-gray-800">
              Welcome Back to Smart Banana Farming
            </h2>

            <p className="text-lg text-gray-600 mb-6 leading-relaxed">
              Sign in to access your BananaLeaf AI dashboard and continue protecting 
              your crops with our advanced disease detection technology.
            </p>

            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="bg-white p-4 rounded-lg shadow-sm border border-gray-100">
                <div className="font-semibold text-green-700 mb-2">Disease Analytics</div>
                <p className="text-gray-600">Track disease patterns across your plantation over time</p>
              </div>
              <div className="bg-white p-4 rounded-lg shadow-sm border border-gray-100">
                <div className="font-semibold text-green-700 mb-2">Treatment History</div>
                <p className="text-gray-600">Access your complete record of treatments and outcomes</p>
              </div>
              <div className="bg-white p-4 rounded-lg shadow-sm border border-gray-100">
                <div className="font-semibold text-green-700 mb-2">Weather Integration</div>
                <p className="text-gray-600">Get forecasts and alerts tailored to your region</p>
              </div>
              <div className="bg-white p-4 rounded-lg shadow-sm border border-gray-100">
                <div className="font-semibold text-green-700 mb-2">Expert Network</div>
                <p className="text-gray-600">Connect with agriculture specialists and fellow farmers</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="md:w-1/2 flex items-center justify-center">
          <div className="bg-white rounded-2xl shadow-xl p-8 max-w-md w-full">
            ...
            <p className="text-center text-gray-500 mb-6">
              Access your BananaLeaf AI account
            </p>
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <div className="text-sm">
                    <a href="/forgot-password" className="font-medium text-green-600 hover:text-green-800">
                ...
                <div className="pt-2">
                  <button
                    ...
                    className="w-full py-2.5 px-4 rounded-lg bg-green-600 text-white font-medium hover:bg-green-700 transition duration-300 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500 flex items-center justify-center"
                  >
                    {isSubmitting ? (
                      <>
